      ...
      <div class="service_container">
        <div class="box active">
          ...
          <div class="detail-box">
            <h5>
              All done! Your config files are now saved and you can use the addon!
            </h5>
          </div>
        </div>
      </div>
...
if (file_exists($filepath)) {
  echo "Your panelurl.txt file already exists! The existing changes won't be saved! If you want to save them, delete panelurl.txt in the https://yoursite.com/setup1/setup2/setup3/setup4 directory!";
  die();
}

$sitename = htmlspecialchars($_GET['homepage']);
